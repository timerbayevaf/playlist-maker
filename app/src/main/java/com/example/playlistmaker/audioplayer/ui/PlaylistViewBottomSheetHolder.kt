...
class PlaylistViewBottomSheetHolder(
    private val binding: PlaylistViewBottomSheetBinding,
    ...
    companion object {
        fun from(parent: ViewGroup): PlaylistViewBottomSheetHolder {
            val inflater = LayoutInflater.from(parent.context)
            val binding = PlaylistViewBottomSheetBinding.inflate(inflater, parent, false)
            return PlaylistViewBottomSheetHolder(binding)
        }
    }
}
